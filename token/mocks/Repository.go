...
func (_m *Repository) GetTokenSet(userID primitive.ObjectID, hashedRefreshTokenID string, includeParent bool) (*models.TokenSet, error) {
	ret := _m.Called(userID, hashedRefreshTokenID, includeParent)

	var r0 *models.TokenSet
	if rf, ok := ret.Get(0).(func(primitive.ObjectID, string, bool) *models.TokenSet); ok {
